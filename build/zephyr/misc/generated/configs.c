...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_LALAPADMINI_LEFT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_IDLE_INTERVAL_MS, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_STATUS_ADV_ACTIVITY_TIMEOUT_MS, 2000);
